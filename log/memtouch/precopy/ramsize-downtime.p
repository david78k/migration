...
plot data using ($0-0.15):3:xticlabel(1) title 'default' smooth freq with boxes lc rgb "black", data using ($0+0.15):5 title 'xbzrle' smooth freq with boxes lc rgb "grey"
