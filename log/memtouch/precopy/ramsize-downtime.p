...
plot data using ($0):3 title 'default' smooth freq with boxes lc rgb "black", data using ($0+0.3):5 title 'xbzrle' smooth freq with boxes lc rgb "grey", data using 0:(0):xticlabel(1) title '' w l
