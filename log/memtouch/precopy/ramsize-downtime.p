...
plot data using ($0-0.15):3 title 'default' smooth freq with boxes lc rgb "black", data using ($0+0.15):5:xticlabel(1) title 'xbzrle' smooth freq with boxes lc rgb "grey"
