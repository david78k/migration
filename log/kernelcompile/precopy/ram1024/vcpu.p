...
# downtime
plot data using ($0-0.4):3 title 'default' smooth freq with boxes lc rgb "black", data using ($0-0.2):8 title 'xbzrle' smooth freq with boxes lc rgb "grey", data using ($0+0.1):13 title 'auto-converge' smooth freq with boxes lc rgb "white", data using ($0+0.3):18 title 'xbzrle+auto-converge' smooth freq with boxes lc rgb "red", data using 0:(0):xticlabel(1) title '' w l
