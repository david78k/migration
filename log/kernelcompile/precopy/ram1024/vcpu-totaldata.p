...
plot data using ($0-0.3):4 title 'default' smooth freq with boxes lc rgb 'black', data using ($0-0.1):10 title 'xbzrle' smooth freq with boxes lc rgb 'grey', data using ($0+0.1):16 title 'auto-converge' smooth freq with boxes lc rgb 'white', data using ($0+0.3):22 title 'xbzrle+auto-converge' smooth freq with boxes fs pattern 1 lc rgb 'black', data using 0:(0):xticlabel(1) title '' w l
