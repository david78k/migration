...
plot data using ($0-0.3):2 title 'default' smooth freq with boxes lc rgb 'white', data using ($0-0.1):8 title 'xbzrle' smooth freq with boxes lc rgb 'grey', data using ($0+0.1):14 title 'auto-converge' smooth freq with boxes lc rgb 'white', data using ($0+0.3):20 title 'xbzrle+auto-converge' smooth freq with boxes lc rgb 'black', data using 0:(0):xticlabel(1) title '' w l 
