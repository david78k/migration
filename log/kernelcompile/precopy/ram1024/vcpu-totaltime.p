...
plot data using ($0-0.3):2 title 'default' with boxes fill pattern 4 8, data using ($0-0.1):8 title 'xbzrle' with boxes fill pattern 3 9,data using ($0+0.1):14 title 'auto-converge' with boxes lc rgb 'white', data using ($0+0.3):20 title 'xbzrle+auto-converge' with boxes lc rgb 'black', data using 0:(0):xticlabel(1) title '' 
