...
plot data using ($0-0.3):2 title 'default', data using ($0-0.1):8 title 'xbzrle',data using ($0+0.1):14 title 'auto-converge', data using ($0+0.3):20 title 'xbzrle+auto-converge', data using 0:(0):xticlabel(1) title '' fs pattern 6 
