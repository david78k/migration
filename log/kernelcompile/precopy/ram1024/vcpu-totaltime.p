...
plot data using ($0-0.3):2 title 'default' with boxes, data using ($0-0.1):8 title 'xbzrle' with boxes,data using ($0+0.1):14 title 'auto-converge' with boxes, data using ($0+0.3):20 title 'xbzrle+auto-converge' with boxes, data using 0:(0):xticlabel(1) title '' 
