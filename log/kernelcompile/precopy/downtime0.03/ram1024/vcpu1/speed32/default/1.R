...
cpus <- read.table(pipe("awk '{print }' ../log/kernelcompile/precopy/default/default/default/default/default/1.dstat | sed '1,2d'"))
#cpus <- read.table(pipe("awk '{print }' ../log/kernelcompile/precopy/default/default/default/default/default/1.dstat"), skip=2)
