...
require(devEMF)
emf('../log/kernelcompile/precopy/default/default/default/default/default/1.dest.emf')

#png("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.emf")
#postscript("plot.eps")
#emf("plot.emf")

#cpus <- scan (pipe("awk '{print }' ../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat"), skip=2)
#cpus <- read.table("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat", colClasses=3)

# header = TRUE ignores the first line, check.names = FALSE allows '+' in 'C++'
#benchmark <- read.table("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat", header = TRUE, row.names = "time", check.names = FALSE)
#benchmark <- read.table("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat", check.names = FALSE, comment.char = "#")
#benchmark <- read.table("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat", header = TRUE, check.names = FALSE, comment.char = "#")
#benchmark <- read.table("../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat", check.names = FALSE)
...
cpus <- read.table(pipe("awk '{print $3}' ../log/kernelcompile/precopy/default/default/default/default/default/1.dest.dstat"), skip=30, nrows=100)
