...
require(devEMF)
emf('../log/idle/postcopy/src.c11node9.r1.emf')

#png("../log/idle/postcopy/src.c11node9.r1.emf")
#postscript("plot.eps")
#emf("plot.emf")

#cpus <- scan (pipe("awk '{print }' ../log/idle/postcopy/src.c11node9.r1.cpu"), skip=2)
#cpus <- read.table("../log/idle/postcopy/src.c11node9.r1.cpu", colClasses=3)

# header = TRUE ignores the first line, check.names = FALSE allows '+' in 'C++'
#benchmark <- read.table("../log/idle/postcopy/src.c11node9.r1.cpu", header = TRUE, row.names = "time", check.names = FALSE)
#benchmark <- read.table("../log/idle/postcopy/src.c11node9.r1.cpu", check.names = FALSE, comment.char = "#")
#benchmark <- read.table("../log/idle/postcopy/src.c11node9.r1.cpu", header = TRUE, check.names = FALSE, comment.char = "#")
...
barplot(t(100 - as.matrix(cpus)), cex.axis = 1.5, cex.lab = 1.5, cex.names = 1.5, xlab = "TIME (SEC)", ylab = "CPU USAGE (%)")
