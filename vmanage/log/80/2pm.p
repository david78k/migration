...
#set xr [0.0:(/nfs/vmanage/log/0/genscriptconcurrencyall+1).022]
set yr [0:]
#set y2r [0:]
...
data using 2:($0+1) title '2VMs' with linespoints, \
data using 3:($0+1) title '4VMs' with linespoints, \
data using 4:($0+1) title '8VMs' with linespoints
