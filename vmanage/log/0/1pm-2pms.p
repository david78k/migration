...
#plot data using 1:($0+1) title '1VM' with linespoints, \

plot data using 2:($0+1) title '1cPM-2cVMs' with linespoints, \
data using 3:($0+1) title '1cPM-4cVMs' with linespoints, \
data using 4:($0+1) title '1cPM-8cVMs' with linespoints, \
data using 5:($0+1) title '2cPMs-1cVMs' with linespoints, \
data using 6:($0+1) title '2cPMs-2cVMs' with linespoints, \
